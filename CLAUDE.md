...
| **14_前后端页面对应关系.md** | ⭐ 18个页面设计 |
| 08_策略应用场景详解.md | 业务流程理解 |
| 16_前后端协作指南.md | 协作方式 |
...
**页面（18个）**：详见 14_前后端页面对应关系.md

- 登录页、首页Dashboard、产品列表/详情/编辑
- 企业定位、40题自诊、四层评估、利润模型
- 策略执行中心、多产品对比、审批流程、BI监控
- 历史趋势、SOP执行、检查清单、压力测试、系统设置

**API封装（55个）**：详见 13_完整API接口契约.md

**Mock数据**：为每个API准备Mock数据，用于独立开发

### 💡 开发建议

查看 TASK_PROGRESS.md 了解后端API是否Ready：
- 如果Ready → 对接真实API
- 如果没Ready → 用Mock数据开发
